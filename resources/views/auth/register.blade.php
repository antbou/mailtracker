    ...
    <x-breeze.auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-breeze.input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required
                    autofocus />
            </div>

            <!-- Name -->
            <div class="mt-4">
                <x-breeze.label for="fullname" :value="__('Fullname')" />

                <x-breeze.input id="fullname" class="block mt-1 w-full" type="text" name="fullname"
