                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-6">
                                <div class="px-4 sm:px-0">
                                    <h3 class="text-lg font-medium leading-6 text-gray-900">Modifier votre tracker !</h3>
                            ...
                            <div class="col-span-6 sm:col-span-6">
                                ...
                                <input type="text" value="{{ $tracker->title }}" name="object" id="object"
                            ...
                            <div class="col-span-6 sm:col-span-6">
                                <label for="email-address" class="block text-sm font-medium text-gray-700">Adresse
                                    Email</label>
                                <input type="text" value="{{ $tracker->email }}" name="email-address"
                            ...
                            <div class="col-span-6 sm:col-span-6">
                                ...
                                <select id="state" name="state" autocomplete="state-name"
                                    ...
                                    @foreach (App\Models\State::allAvailable()->get() as $state)
                                        <option value="{{ $state->slug }}"
                                            {{ $tracker->state == $state ? 'selected' : '' }}>
                                            {{ $state->name }}</option>
                                    @endforeach
                                </select>
                                @error('state')
